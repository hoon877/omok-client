...
namespace LeeGyuDae
{
    public class RankingBoardPanelController : MonoBehaviour
    {
        ...
        private GameObject scrollRectGameObject;
        ...
        [Header("Profile Images")] [SerializeField]
        private Sprite[] profileImageSprites;
        ...
        {
            var cellObject = RankingBoardCellObjectPool.Instance.GetObject();
        ...
        private void ScrollUp()
        {
            ...
            {
                RankingBoardCellObjectPool.Instance.ReturnObject(lastCell.gameObject);
        ...
        private void ScrollDown()
        {
            ...
            {
                RankingBoardCellObjectPool.Instance.ReturnObject(fistCell.gameObject);
